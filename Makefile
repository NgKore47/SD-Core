...
$(M)/helm-ready: | $(M)/k8s-ready
	helm repo add incubator https://wafi981.github.io/incubator/
	helm repo add cord https://wafi981.github.io/opencord/
	helm repo add atomix https://wafi981.github.io/atomix/
	helm repo add onosproject https://wafi981.github.io/onos/
	helm repo add aether https://wafi981.github.io/aetherproject/
	helm repo add rancher http://charts.rancher.io/
	touch $@
endif
